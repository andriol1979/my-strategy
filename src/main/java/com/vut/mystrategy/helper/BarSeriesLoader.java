...
public class BarSeriesLoader {
    ...
    public static Bar convertKlineEventToBar(KlineEvent klineEvent) {
        ...
        MyStrategyBaseBar bar = MyStrategyBaseBar.builder()
                ...
                .beginTime(Utility.getZonedDateTimeByEpochMilli(klineEvent.getKlineData().getStartTime()))
                .endTime(Utility.getZonedDateTimeByEpochMilli(klineEvent.getKlineData().getCloseTime()))
