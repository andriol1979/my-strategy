...
public class PriceNearResistanceRule {
    ...
    public static Rule buildRule(BarSeries barSeries, BigDecimal threshold) {
        ...
        LogMessage.printObjectLogMessage(log, resistanceLevel, "");
        ...
        LogMessage.printObjectLogMessage(log, priceNearResistance, "PriceNearResistance");
        return priceNearResistance;
    }
}
