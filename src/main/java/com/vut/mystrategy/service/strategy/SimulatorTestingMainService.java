...
import static com.vut.mystrategy.service.strategy.EMACrossOverStrategy.*;

@Slf4j
public class SimulatorTestingMainService {
    public static void main(String[] args) {
        ...
        allBars = allBars.subList(0, 1500);
...
//                log.info("LONG Index: {} - Price: {}", series.getEndIndex(), series.getBar(endIndex).getClosePrice());
//            } else if (strategy.shouldExit(endIndex)) {
//                tradingRecord.exit(endIndex, series.getBar(endIndex).getClosePrice(), series.numOf(1));
//                log.info("SHORT Index: {} - Price: {}", series.getEndIndex(), series.getBar(endIndex).getClosePrice());
//            }
        }
